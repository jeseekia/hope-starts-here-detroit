  ...
  <div class="panel panel-default">
    <div class="panel-body">
      ...
      <div class="page-content-wrapper">
        ...
        <p>
          is a <strong>community engagement and strategic planning process</strong> designed to create a vision and action plan to make Detroit an equitable, world-class city for our youngest residents and their families.
        </p>
        <p>
        ...
        <p>
          ...
          <br/>
          <strong>
          info@hopestartsheredetroit.org
          </strong>
        </p>
      </div>
    </div>
